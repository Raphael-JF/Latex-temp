...
\begin{theoreme}{34.28}{algorithme d'orthonormalisation de Gram-Schmidt}
    Soit $E$ un espace préhilbertien réel et $F = (f_1, \dots, f_n)$ une famille libre de $E$. À partir de $F$, il est possible de construire une famille orthonormale $(u_1, \dots u_k)$, telle que :
