...
\begin{definition}{34.19 (4)}{famille orthonormée}
    Soit $E$ un espace préhilbertien réel, $(x_i)_{i \in I}$ une famille d'éléments de $E$.
    On dit que $(x_i)_{i \in I}$ est \notion{orthonormée} si elle est {orthogonale} et {constituée de vecteurs unitaires}, \ie :
...
\begin{definition}{34.39}{vecteurs normaux à un hyperplan}
    Soit $E$ un espace euclidien de dimension $n \neq 0$ et $H$ un hyperplan de $E$. Le sous-espace $H^\bot$ est une droite dont tout vecteur non nul est dit \notion{vecteur normal à $H$}.
\end{definition}
