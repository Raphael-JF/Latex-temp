...
\usepackage{ulem}   % pour souligner avec des pointillés
...
\newenvironment{exemple}[2]
{
    ...
    \begin{boite_exemple}
    \if\relax\detokenize{#1}\relax
        \textbf{\textcolor{bleufonce}{Exemple \numerochapitre.\arabic{boite}}}%
        \if\relax\detokenize{#2}\relax
        \else
            \textit{ - #2}
        \fi
...
\newenvironment{remarque}[2]
{
    ...
    \if\relax\detokenize{#1}\relax
        \textbf{\textcolor{bleufonce}{Remarque \numerochapitre.\arabic{boite}}}%
        \if\relax\detokenize{#2}\relax
        \else
            \textit{ - #2}
        \fi
...
\newenvironment{exercice}[2]
{
    ...
    \begin{boite_remarque}
    \if\relax\detokenize{#1}\relax
        \textbf{\textcolor{bleufonce}{Exercice \numerochapitre.\arabic{exercice}}}%
        \if\relax\detokenize{#2}\relax
        \else
            \textit{ - #2}
        \fi
    ...
    \else
        \textbf{\textcolor{bleufonce}{Exercice #1}}%
        \if\relax\detokenize{#2}\relax
        \else
            \textit{ - #2}
        \fi
