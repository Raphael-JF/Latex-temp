...
\begin{theoreme}{1.71}{produits de groupes quotients}
    Soit $(n,\, p) \in \Z^2$ premiers entre eux. Les groupes $\gpquotient{np}$ et $(\gpquotient{n}) \times (\gpquotient{p})$ sont isomorphes.
\end{theoreme}

\begin{theoreme}{1.72}{chinois}
    Soit $(n,\, p) \in \Z^2$ premiers entre eux. Le système de congruences :
    $$\begin{cases*}
        x \equiv a &[$n$] \\
        x \equiv b &[$p$] \\
    \end{cases*}$$
    admet au moins une solution $c \in \Z$. l'ensemble des solutions est la classe de $c$ modulo $np$.
\end{theoreme}
...
\begin{definition}{1.76}{ordre d'un groupe fini, ordre d'un élément d'un groupe}
...
\begin{theoreme}{1.79}{ordre d'un élément d'un groupe fini}
