...
\begin{proposition}{3.38}{caractérisation de l'adhérence}
    Soit $E$ un espace vectoriel normé. L’élément $a$ est une valeur d’adhérence de $(u_n)_{n \in \N} \in E^\N$  si et seulement si pour tout $n_0 \in \N$, toute boule centrée en $a$ contient au moins un terme de la suite de rang supérieur ou égal à $n_0$~:
    $$\forall n_0 \in \N,\, \forall r > 0,\, \exists N \geq n_0,\, \norme{u_N - a} < r$$
\end{proposition}
