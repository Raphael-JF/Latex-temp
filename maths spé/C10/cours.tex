...
\begin{theoreme}{10.47}{formule de Taylor avec reste intégral}
    Soit $f\in \mc{D}^{n}(I,E)$ telle que $f^{(n+1)}$ est continue par morceaux sur l'intervalle $I$. Pour $a \in I$~:
...
\begin{theoreme}{10.48}{inégalité de Taylor-Lagrange}
    Soit $f\in \mc{D}^{n}(I,E)$ telle que $f^{(n+1)}$ est continue par morceaux sur l'intervalle $I$. Soit $\seg{a}{b} \subset I$ et $M$ un majorant de $\norme{f^{(n+1)}}_E$ sur $\seg{a}{b}$. Alors~:
...
\begin{theoreme}{10.66}{primitivation d'une limite uniforme de suite de fonctions}
    ...
    \end{enumeratebf}
    la suite $(F_n)_{n \in \N}$ des primitives des $f_n$ respectives s'annulant toutes en un même $a \in I$ converge uniformément vers la primitive de $f$ s'annulant en $a$, et ce sur tout segment inclus dans $I$.
\end{theoreme}
