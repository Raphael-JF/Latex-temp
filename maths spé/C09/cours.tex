...
\begin{theoreme}{9.47}{premier de Weierstrass}
    Toute fonction continue sur $\seg{a}{b}$, à valeurs réelles ou complexes, est limite uniforme sur $\seg{a}{b}$ d’une suite de fonctions polynomiales.
\end{theoreme}
...
\begin{theoreme}{9.49}{deuxième de Weierstrass}
    ...
    $$\bigg(t \mapsto \sum_{k=1}^n \alpha_k e^{\frac{2ik\pi}{T}t}\bigg)_{n \in \N}$$
