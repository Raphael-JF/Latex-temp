...
\section{Objectif}
Demande de mobilité internationale étudiante pour le semestre 8 de l'Enseirb-Matmeca.
...
\vspace{0.5em}
\cvitem{Enseignement}{Tutorat présenciel en sciences pour des élèves de collège et lycée, chez \href{https://www.alveusclub.com/}{Alveus}. Une soixantaine d'heures de cours dispensées de novembre 2025 à aujourd'hui, principalement en physique et en mathématiques.}
\cvitem{Web}{Création de sites en \texttt{HTML}, \texttt{CSS}, \texttt{Javascript} dans un cadre aussi bien personnel que scolaire.}
\vspace{0.5em}
\cvitem{Docs}{Stage de de préparation et d'animation d'un atelier "Apprendre à discuter avec l'IA" pour des élèves de seconde, pour l'Enseirb-Matmeca.}
\vspace{0.5em}
