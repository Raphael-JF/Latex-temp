...
\cvitem{Prog. embarquée}{Conception intégrale (boitier, firmware sur ESP32) d'un ordinateur de bord pour vélo, avec indication GPS et heure (commande via Bluetooth depuis un smartphone).}
\vspace{0.5em}
