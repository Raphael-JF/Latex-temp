...
\begin{definition}{2.11}{langage local}
    Soit $\Sigma$ un alphabet fini et $L \subset \Sigma^*$ un langage. On dit que \notion{$L$ est local} s'il existe $P \subset \Sigma$, $S \subset \Sigma$ et $F \in \Sigma_2$ telles que :
...
\begin{theoreme}{2.26}{lemme d'Arden}
    Soit $A$ et $B$ deux langages sur un même alphabet $\Sigma$. l'équation $L = AL\cup B$ admet $A^*B$ pour solution. Plus précisément, pour $L$ une solution~:
    \begin{itemize}
        \item $A^*B \subset L$
        \item si $\epsilon \notin A$, alors $L \subset A^*B$. La solution est unique.
    \end{itemize}
\end{theoreme}
