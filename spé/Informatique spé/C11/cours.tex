...
\begin{demonstration}
    ...
    $$\varphi \text{ satisfiable } \Longleftrightarrow g(\varphi) \text{ satisfiable }$$
    $\boxed{\implies}$ : Si $\varphi$ est satisfiable, soit $v$ un modèle de $\varphi$. On souhaite le prolonger sur les nouvelles variables en $\widetilde{v}$ de sorte que $\widetilde{v}$ satisfasse $g(\varphi)$.\\
    ...
    \begin{center}
    \includegraphics[width=0.6\textwidth]{100.jpg}
    \end{center}
...
\begin{demonstration}
    ...
    \begin{itemize}
        ...
        \begin{center}
            \includegraphics[width=0.3\textwidth]{101.jpg}
        \end{center}
...
\begin{demonstration}
        ...
        On construit le graphe $G_{\mc{V}_\varphi}$ en utilisant $n$ fois ce graphe gadget : une fois pour chaque variable !
        \begin{center}
            \includegraphics[width=0.3\textwidth]{102.jpg}
        \end{center}
        ...
        $$v(x_i)  = \begin{cases*}
            ...
            F &sinon
        \end{cases*}$$
        Pour chaque classe $C_j$, on rajoute un sommet en fonction des cas, comme dans la figure suivante.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{103.jpg}
        \end{center}
\end{demonstration}
\begin{demonstration}
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{104.jpg}
\end{center}
...
\begin{remarque}{}{introduction aux machines de Turing}
    ...
    \begin{center}
        \includegraphics[width=0.6\textwidth]{105.jpg}
    \end{center}
...
\begin{exemple}{}{de machine de Turing}
    \begin{center}
        \includegraphics[width=0.6\textwidth]{106.jpg}
    \end{center}
...
\begin{exemple}{}{de configuration dans une machine de Turing}
    ...
    \begin{center}
        \includegraphics[width=0.6\textwidth]{107.jpg}
    \end{center}
...
\begin{exemple}{}{d'encodages}
    ...
    est un encodage de~:
    \begin{center}
        \includegraphics[width=0.6\textwidth]{108.jpg}
    \end{center}
\end{exemple}
