...
\begin{definition}{6.10}{arbre de recherche de solutions}
    ...
    \end{itemize}
    On définit alors une \notion{fonction $\varphi$ d'évaluation} qui à un noeud $n$ d'étiquette $S$ associe ce qu'on peut espérer au mieux dans l'exploration du sous-arbre~:
    $$\begin{cases*}
...
\begin{definition}{6.12}{relaxation d'un problème d'optimisation}
...
\begin{definition}{6.13}{généralisation d'un problème d'optimisation}
