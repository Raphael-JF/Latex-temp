...
\begin{definition}{7.22}{formule de la logique du premier ordre}
    L'ensemble des formules de la logique du premier ordre pour un langage du premier ordre est défini inductivement~:
    \begin{enumeratebf}
        ...
        \end{itemize}
        \item pour $F_1$ et $F_2$ deux telles formules~: 
        \begin{itemize}
        ...
        \end{itemize}
        \item $F(x)$ un formule faisant intervenir la variable $x$~:
        \begin{itemize}
