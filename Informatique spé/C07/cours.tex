...
\begin{definition}{7.22}{formule de la logique du premier ordre}
    ...
    \begin{enumeratebf}
        ...
        \begin{itemize}
            ...
            \item pour $t_1, \dots, t_k$ des termes et $\mc{R}$ un symbole de relation d'arité $k$, $R(t_1,\dots, t_k)$ est une formule atomique
        \end{itemize}
        ...
        \end{itemize}
        \item $F(x)$ une formule de la logique du premier ordre faisant intervenir la variable $x$~:
        \begin{itemize}
