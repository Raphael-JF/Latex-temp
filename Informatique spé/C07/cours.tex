...
\begin{definition}{7.20}{logique du premier ordre, langage du premier ordre}
    ...
    \end{itemize}
    Les constantes et images des symboles de fonctions sont des éléments d'un ensemble d'étude, appelé \notion{domaine}, qui dépend du langage du premier ordre
\end{definition}
...
\begin{definition}{7.24}{caractères libre et lié d'une occurrence d'une variable}
    ...
    \begin{itemize}
        \item \notion{libre} si elle n'est dans la portée d'aucun quantificateur.
        \item \notion{liée} si elle est dans la portée d'au moins quantificateur.
    \end{itemize}
\end{definition}
...
\begin{definition}{7.25}{caractères libre et lié d'un variable dans une formule}
    ...
    \begin{itemize}
        \item \notion{libre dans $F$} s'il existe une occurrence de $x$ libre dans $F$
        \item \notion{liée dans $F$} s'il existe une occurrence de $x$ libre dans $F$.
    \end{itemize}
\end{definition}


\begin{definition}{7.24}{règle d'introduction du quantificateur universel}
    En déduction naturelle munie de la logique du premier ordre, Pour un ensemble $\Gamma$ de formules de la logique propositionnelle, pour toutes formules $A$ et $B$~:
    $$\frac{\Gamma \these \varphi(x)}{\Gamma \these \forall x.\varphi(x)}(\mr{i}\forall)$$
    valable si toutes les occurrences de $x$ sont non libres.
    telle est la \notion{règle d'élimination du quantificateur universel}.
\end{definition}
