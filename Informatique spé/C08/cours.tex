...
\begin{definition}{}{section critique}
    Une \notion{section critique} est une suite d'instructions (portion de code) d'un processus nécessitant d'accéder à une ressource unique et commune pour plusieus fils d'exécution. On parle de \notion{variable partagée}
\end{definition}
...
\begin{remarque}{}{comparaison entre sémaphores à compteur et mutex}
    Les sémaphores sont moins restricts que les mutexs : on peut avoir des fils qui font uniquement de la demande d'accès et des fils qui font uniquement de la fin d'accès (production de ressources).
\end{remarque}
