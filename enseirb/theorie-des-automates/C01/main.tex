...
\newcommand{\texteNomCours}{Cours de théorie des automates}  

% texte indiquant le nom du professeur encadrant, formulation comprise
\newcommand{\texteNomProf}{cours dispensé par David Janin} 

% numéro du chapitre
\newcommand{\numeroChapitre}{1}

% nom du chapitre
\newcommand{\texteNomChapitre}{Lettres et mots} 
...
\section{Alphabet, lettres et mots}
