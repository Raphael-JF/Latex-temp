...
\subsection{Première semaine : Conceptualisation de l'atelier}
 ...
 Plusieurs idées ont été proposées pour l'atelier, mais la plupart nous ont paru assez peu pertinentes ou abordables pour des élèves de seconde. En effet, il a été difficile de trouver un sujet qui soit à la fois intéressant et compréhensible pour des élèves de cet âge. Après plusieurs discussions, nous avons finalement décidé de nous concentrer sur un atelier axé en deux parties~:
\begin{itemize}
  \item Une première partie consiste à faire réfléchir les élèves sur le fonctionnement primitif d'un modèle de langage, en transposant les problèmes rencontrés à des problèmes du quotidient comme "Deviner la suite d'une suite de symboles".

  \item La seconde partie consiste à introduire aux élèves à l'utilisation d'un modèle de langage, d'abord simplemet en leur laissant parler avec celui-ci, puis en leur faisant découvrir les limites de ce modèle et les biais qu'il peut contenir. 
\end{itemize}
