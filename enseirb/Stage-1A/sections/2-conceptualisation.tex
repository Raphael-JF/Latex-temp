\section{Première semaine : Conceptualisation de l'atelier}
 ...
 Plusieurs idées ont été proposées pour l'atelier, mais la plupart nous ont paru assez peu pertinentes ou peu accessibles à des élèves de seconde. En effet, il a été difficile de trouver un sujet qui soit à la fois intéressant et compréhensible pour des élèves de cet âge. La connaissance que j'ai acquise grâce à mon expérience de soutien scolaire m'a permis de savoir précisément ce que les élèves pouvaient aborder à leur niveau. Après plusieurs discussions, nous avons finalement décidé de nous concentrer sur un atelier organisé en deux parties~:
\begin{itemize}
  \item Une première partie consiste à faire réfléchir les élèves sur le fonctionnement primitif d'un modèle de langage, en transposant les problèmes rencontrés à des problèmes du quotidien comme "Deviner la suite d'une série de symboles".
