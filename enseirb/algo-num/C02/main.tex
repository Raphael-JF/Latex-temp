...
\newcommand{\texteNomCours}{Cours d'algorithmique numérique}  

% texte indiquant le nom du professeur encadrant, formulation comprise
\newcommand{\texteNomProf}{cours dispensé par Marc Durufle} 

% numéro du chapitre
\newcommand{\numeroChapitre}{2}

% nom du chapitre
\newcommand{\texteNomChapitre}{Résolution numérique de systèmes linéaires} 
...
\usepackage{hhline} % pour les lignes spéciales dans les tableaux
...
\section{Cas où $A$ n'est que symétrique}
\input{sections/section3}

\section{Cas où $A$ n'est pas symétrique}
