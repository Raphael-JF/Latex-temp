...
\newcommand{\texteNomCours}{Cours d'algorithmique distribuée}  

% texte indiquant le nom du professeur encadrant, formulation comprise
\newcommand{\texteNomProf}{cours dispensé par M. Cyril Gavoille} 

% numéro du chapitre
\newcommand{\numeroChapitre}{2}

% nom du chapitre
\newcommand{\texteNomChapitre}{Modèles et complexités} 
