...
\begin{theoreme}{}{lemme de sommation}
    ...
    \begin{enumeratebf}
        ...
        \item toute primitive $G$ de $g$ vérifie $G(n) \symbolelim{n \to + \infty}{}{=} \Theta\Big(G(n+1)\Big)$
    \end{enumeratebf}
...
\begin{demonstration}
    ...
    Ces fractions sont bornées par hypothèse de comparabilité. Elles sont donc bornées à partir d'un certain rang et on en déduit l'existence de $C_1$ et $C_2$.
\end{demonstration}
