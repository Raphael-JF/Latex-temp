...
\begin{align*}
    ...
    \text{donc} \qquad &\ln(n) \geq \frac{\ln(100K_1)}{1-\alpha}\\
    \text{donc} \qquad &n \geq (100K_1)^{\frac{1}{1-\alpha}}
\end{align*}
...
\begin{itemize}
    \item Pour $\alpha = \frac{1}{2}$, on obtient le minorant $n_\mr{min} = 100^2 = 10^4$
    \item Pour $\alpha = 0.9$, on obtient le minorant $n_\mr{min} = 100^{10} = 10^{20}$
\end{itemize}
