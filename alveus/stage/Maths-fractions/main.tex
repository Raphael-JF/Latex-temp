...
\subsection{Diviser une fraction par une autre}

Pour diviser une fraction par une autre, il suffit de multiplier la première fraction par l'inverse de la seconde. On dit que \notion{diviser par un nombre} revient à \notion{multiplier par son inverse}.

\begin{proposition}{}{division de fractions}
...
\begin{remarque}{}{}
    ...
    $$\frac{\Big(\frac{a}{b}\Big)}{\Big(\frac{c}{d}\Big)}$$
\end{remarque}
...
\begin{exercice}{}{}
    ...
    \begin{enumeratebf}
        ...
        \item $\frac{3}{16} + \frac{1}{48}\times 2$
        \item $\frac{5}{6} + \frac{7}{8} + 1$
        \item $\frac{2}{3} \times 3 + \frac{1}{4}$
    \end{enumeratebf}
\end{exercice}
